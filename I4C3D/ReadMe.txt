========================================================================
    Win32 アプリケーション: I4C3D プロジェクトの概要
========================================================================

この I4C3D アプリケーションは、AppWizard により作成されました。
...
I4C3D.ico
    ...
    ファイルです。
    このアイコンは、メイン リソース ファイル I4C3D.rc 
    にインクルードされます。

small.ico
    これは、アプリケーションのアイコンの小さいバージョン (16x16) を含むアイコン 
    ファイルです。 このアイコンは、メイン リソース ファイル I4C3D.rc 
    にインクルードされます。
